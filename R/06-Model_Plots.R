...
# Save as eps
ggsave('figures/fig3.eps', plot = last_plot(), device = 'eps', width = 21, height = 18, units = 'cm', dpi = 300, bg = 'white')
...
# Save as eps
ggsave('figures/fig4.eps', plot = last_plot(), device = 'eps', width = 18, height = 12, units = 'cm', dpi = 300, bg = 'white')
